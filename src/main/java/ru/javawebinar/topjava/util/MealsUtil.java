...
public class MealsUtil {
    public static Integer DEFAULT_ADMIN_ID = 1;
    public static Integer DEFAULT_USER_ID = 2;
    ...
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(USERS.get(DEFAULT_ADMIN_ID).getId(), LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500),
            new Meal(USERS.get(DEFAULT_ADMIN_ID).getId(), LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000),
            new Meal(USERS.get(DEFAULT_ADMIN_ID).getId(), LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500),
            new Meal(USERS.get(DEFAULT_USER_ID).getId(), LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000),
            new Meal(USERS.get(DEFAULT_USER_ID).getId(), LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
            new Meal(USERS.get(DEFAULT_USER_ID).getId(), LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510)
    );
